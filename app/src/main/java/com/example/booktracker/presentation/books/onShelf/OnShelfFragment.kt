package com.example.booktracker.presentation.books.onShelf
...
class OnShelfFragment : Fragment() {
            ...
            viewModel.state.collect { state ->
                when (state) {
                    ...
                    is BookState.Success -> {
                        binding.pbLoading.isVisible = false
                        val filteredBooks = state.books.filter { it.loanedTo.isNullOrEmpty() }
